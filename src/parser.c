...
enum {
  ...
  sym_true = 52,
  sym_false = 53,
  sym__not_operator = 54,
  sym__and_operator = 55,
  sym__or_operator = 56,
  sym__implies_operator = 57,
  sym__iff_operator = 58,
  sym__forall_operator = 59,
  sym__exists_operator = 60,
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_true] = STATE(12),
    [sym_false] = STATE(12),
    [sym__not_operator] = STATE(15),
    [sym__forall_operator] = STATE(16),
    [sym__exists_operator] = STATE(17),
  ...
  [2] = {
    ...
    [sym_true] = STATE(28),
    [sym_false] = STATE(28),
    [sym__not_operator] = STATE(31),
    [sym__forall_operator] = STATE(32),
    [sym__exists_operator] = STATE(33),
    [sym_comment] = ACTIONS(7),
  ...
  [12] = {
    [sym__and_operator] = STATE(36),
    [sym__or_operator] = STATE(37),
    [sym__implies_operator] = STATE(38),
    [sym__iff_operator] = STATE(39),
    [sym_comment] = ACTIONS(63),
  ...
  [28] = {
    [sym__and_operator] = STATE(48),
    [sym__or_operator] = STATE(49),
    [sym__implies_operator] = STATE(50),
    [sym__iff_operator] = STATE(51),
    [sym_comment] = ACTIONS(7),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [69] = {.count = 1, .reusable = false}, REDUCE(sym__forall_operator, 1),
  [71] = {.count = 1, .reusable = false}, REDUCE(sym__exists_operator, 1),
  ...
  [115] = {.count = 1, .reusable = true}, REDUCE(sym__forall_operator, 1),
  [117] = {.count = 1, .reusable = true}, REDUCE(sym__exists_operator, 1),
