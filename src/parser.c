...
static const char *ts_symbol_names[] = {
  ...
  [sym__reserved_func_name_2] = "function_name",
  [sym_true] = "true",
  [sym_false] = "false",
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym__reserved_func_name_2] = STATE(10),
    [sym_true] = STATE(8),
    [sym_false] = STATE(8),
  ...
  [20] = {
    ...
    [sym__reserved_func_name_2] = STATE(36),
    [sym_true] = STATE(34),
    [sym_false] = STATE(34),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [43] = {.count = 1, .reusable = false}, REDUCE(sym__reserved_func_name_2, 1),
  ...
  [164] = {.count = 1, .reusable = true}, REDUCE(sym__reserved_func_name_2, 1),
